...
namespace DSMS.DSW.Control.Class
{
    public class FormsAutoSize
    {
        ...
        private static System.Windows.Forms.Form myForm;

         public static void AutoSize(System.Windows.Forms.Form frm)
        {
            myForm = frm;
         ...
         private static void setControls(float newx, float newy, System.Windows.Forms.Control cons)
        {
         ...
         private static void FrmMain_Resize(object sender, EventArgs e)
        {
